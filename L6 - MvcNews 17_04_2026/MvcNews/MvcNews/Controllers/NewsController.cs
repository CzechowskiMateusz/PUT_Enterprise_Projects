    ...
    public class NewsController : Controller
    {
            ...
            if (ModelState.IsValid)
            {
                ...
                catch (DbUpdateConcurrencyException ex)
                {
                    ...
                    else
                    {
                        ...
                        ModelState.AddModelError("TimeStamp", $"Aktualna wartość w bazie: {databaseEntity.TimeStamp}");
                        ModelState.AddModelError("Text", $"Aktualna wartość w bazie: {databaseEntity.Text}");
        ...
        public async Task<IActionResult> DeleteConfirmed(int id, NewsItem newsItem)
        {
            ...
            catch (DbUpdateConcurrencyException e) 
            {
                ...
                {
                    ModelState.AddModelError(string.Empty, "Unable to save changes. The record was modified by another user after you got the original value");
